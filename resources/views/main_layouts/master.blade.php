			...
			<div class="container">
				...
				<div class="float--right float--xs-none text-xs-center">
					...
					<ul class="header--topbar-social nav hidden-sm hidden-xxs">
						<li><a href="https://www.facebook.com/ducdepzaihihihi/"><i class="fa fa-facebook"></i></a></li>
						<li><a href="https://www.facebook.com/ducdepzaihihihi/"><i class="fa fa-twitter"></i></a></li>
						<li><a href="https://www.facebook.com/ducdepzaihihihi/"><i class="fa fa-google-plus"></i></a></li>
						<li><a href="https://www.facebook.com/ducdepzaihihihi/"><i class="fa fa-rss"></i></a></li>
						<li><a href="https://www.facebook.com/ducdepzaihihihi/"><i class="fa fa-youtube-play"></i></a></li>
					</ul>
	...
	<footer id="colorlib-footer">
		...
		<div class="container">
			<div style=" padding: 15px 0; display: flex;" class=" row">
				...
				<div class="col-md-4">
					<p>
						<span style="font-size: 14px" class="block">Tổng biên tập: Nhóm TDQ caothang</span>
					</p>
					<p>
						<span style="font-size: 14px" class="block">Địa chỉ: 49 xa lộ hà nội quận 2 thành phố Hồ Chí Minh </span>
					</p>
					<p>
						<span style="font-size: 14px" class="block">Điện thoại: 0392605920</span>
					</p>
				</div>
				<div class="col-md-4">
					<p>
