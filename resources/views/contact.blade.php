						...
						<div class="row">
							<div class="col-md-12">
								<div class="contact-info-wrap-flex">
									<div class="con-info">
										<p><span><i class="icon-location-2"></i></span>49 xa lộ hà nội , <br>quận 2 , TP. Thủ Đức</p>
									</div>
									<div class="con-info">
										<p><span><i class="icon-phone3"></i></span> <a href="tel://0392605920">(+84) 392 605 920</a></p>
									</div>
									<div class="con-info">
										<p><span><i class="icon-paperplane"></i></span> <a href="mailto:phamvanduc280808@gmail.com">phamvanduc280808@gmail.com</a></p>
									</div>
									<div class="con-info">
										<p><span><i class="icon-globe"></i></span> <a href="#">vanduc.com.vn</a></p>
									</div>
								</div>
							</div>
						</div>
